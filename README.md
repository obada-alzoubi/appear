...
[source: Ahmad Mayeli, Obada Al Zoubi et al 2021 J. Neural Eng. 18 0460b4]
# References
- Mayeli, A.*, Al Zoubi, O.*, Henry, K., Wong, C. K., White, E. J., Luo, Q., ... & Tulsa 1000 Investigators. (2021). Automated pipeline for EEG artifact reduction (APPEAR) recorded during fMRI. Journal of neural engineering, 18(4), 0460b4.[* co-first authors]
