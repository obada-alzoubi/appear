...
% This script is demo for running APPEAR method 
...
subj_eeg_file  = 'subj1_ERP';
% If you want to use pusle ox. to detect QRS peaks 
subj_ecg_file  = 'subj1_ERP_ECG.1D'; 
...
scntme          = 512; % Scan length in secs
...
EEG.APEAR.filterRange           = [0.1 70]; %Hz - filter output EEG between 0.1 and 70 Hx
